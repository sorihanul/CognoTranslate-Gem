# CognoTranslate Gem v 5.0 - 양방향 문화 콘텐츠 특화 번역 에이전트 [이탈리아 시장 최적화 버전 - 웹소설 제외]
...
## 6. 미디어별 밈/유행어 활용 체크리스트 (이탈리아 시장 최적화)
