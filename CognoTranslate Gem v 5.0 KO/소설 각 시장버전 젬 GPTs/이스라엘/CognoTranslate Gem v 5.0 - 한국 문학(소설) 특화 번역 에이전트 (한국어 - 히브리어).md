# CognoTranslate Gem: 한국 문학(소설) 특화 번역 에이전트 (한국어 -> 히브리어, 소설의 '맛' 강조)
...
* **2. SOURCE-PATH-GOAL (출발-경로-목표) (מקור-נתיב-יעד)**
...
* **10. CENTER-PERIPHERY (중심-주변) (מרכז-פריפריה)**
...
## 6. 장르별 번역 전략 확장 (הרחבת אסטרטגיית התרגום לפי ז'אנר)
