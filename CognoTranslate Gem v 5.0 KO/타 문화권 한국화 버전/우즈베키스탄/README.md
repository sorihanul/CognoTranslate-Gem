# CognoTranslate Gem: 우즈베키스탄 문학(소설) 특화 번역 에이전트 (우즈베크어 -> 한국어, 소설의 '혼' 재창조)

## 📖 소개

**CognoTranslate Gem: 우즈베키스탄 문학(소설) 특화 번역 에이전트**는 단순한 우즈베크어-한국어 번역을 넘어, 우즈베키스탄 소설 원문의 **'혼'과 미학적 깊이를 한국어로 완벽하게 재창조**하는 데 특화된 지능형 번역 파트너입니다. 우즈베크어 문학 고유의 섬세한 정서, 문화적 배경, 작가의 의도까지 깊이 이해하여, 한국 독자들이 마치 한국 작가가 쓴 소설을 읽는 듯한 몰입감과 감동을 느낄 수 있도록 최고 품질의 문학 번역을 제공합니다.

## 🌟 주요 특징 및 차별점

* **'소설의 혼' 재창조**: 단어 대 단어의 직역을 넘어, 우즈베키스탄 문학 고유의 미학(실크로드의 역사적 깊이, 중앙아시아 유목 문화, 이슬람 전통과 세속주의의 조화, 가족과 공동체 의식 등)과 정서를 한국어 독자에게 가장 자연스럽고 풍부하게 전달합니다.
* **인지 기반 심층 번역**: 언어학적 인지 문법에서 정의하는 '12가지 인지 도식 패턴'을 활용하여, 원문의 숨겨진 개념적 의미와 관계를 파악하고 한국어로 정교하게 재개념화합니다.
* **문화적 이해와 전이**: 우즈베키스탄 문화, 역사, 사회적 맥락을 깊이 이해하고 번역에 반영하며, 필요한 경우 간략한 해설을 통해 독자의 이해를 돕습니다.
* **작가의 문체와 감성 재현**: 원작 작가의 고유한 문체와 인물의 개성적인 목소리, 서술자의 태도를 한국어에 맞춰 섬세하게 재현합니다.
* **장르별 최적화**: 다양한 우즈베키스탄 문학 장르(역사 소설, 설화 기반 소설, 사회 비판 소설 등)에 맞춰 가장 적합한 문체와 어조로 번역하여 장르적 특성을 살립니다.

## 💡 어떻게 작동하나요? (번역 원칙)

이 에이전트는 다음의 핵심 원칙들을 기반으로 번역을 수행합니다:

1.  **의미/의도/개념의 심층 분석**: 우즈베크어 원문의 표면적 의미를 넘어, 작가의 의도와 우즈베크어의 고유한 인지적 틀(개념적 도식, 관점, 개념화 방식)을 파악합니다.
...
4.  **문화적 전이 및 배경 설명**: 우즈베키스탄 문화 고유의 관념, 사건 등을 한국 독자에게 이질감 없이 다가가도록 번역하며 필요시 주석을 제공합니다.
...
번역하고자 하는 **우즈베크어 소설 텍스트(문장, 단락 또는 전체 작품 일부)**를 입력해 주세요. 특별한 지시가 없으면, 에이전트는 위에서 설명한 모든 원칙을 바탕으로 가장 자연스럽고 문학적인 한국어 번역을 제공합니다.

**예시:**
```
"U o'z fikrlarining qafasida qamalib qolganday edi."
```
...
* **원문 인지 도식 심층 분석**: 우즈베크어 원문에 내재된 인지 도식을 식별하고, 그것이 어떤 의미와 정서적 함의를 가지는지 분석합니다.
...
**사용 방법:**
```
/advanced "U o'z fikrlarining qafasida qamalib qolganday edi."
```
또는
```
/advanced
[여기에 번역할 우즈베크어 소설 텍스트 입력]
```
...
**예시 피드백:**
```
"방금 번역된 'U o'z fikrlarining qafasida qamalib qolganday edi.' 문장에서 '자신의 생각이라는 우리에 갇힌 기분이었다'는 표현은 좋지만, 우즈베키스탄 문학 특유의 '중앙아시아 유목 문화'적 배경이 덜 느껴지는 것 같습니다. '그는 마치 자신의 생각이라는 끝없는 초원의 울타리에 갇힌 듯했다'처럼 'CONTAINER' 도식을 좀 더 유목 문화의 배경을 강조하여 표현하면 어떨까요?"
```

## ⚠️ 중요 사항

* **정확한 원문 제공**: 가장 좋은 번역 결과를 위해서는 정확하고 완전한 우즈베크어 원문 텍스트를 제공해 주십시오.
